...
// echo $_SESSION['role'];
// exit();
require __DIR__ . '/config/database.php'; // Include the database connection
require __DIR__. '/vendor/autoload.php'; // Include the database connection



// Fetch order details
$order_id = $_GET['id']; // Assuming you pass the order_id via GET
//get order ids user id
...
//user can see only his invoice not others
if($row['user_id'] != $_SESSION['user_id']){
    echo "Only vendors or admins can see invoices.";
    exit();
}
